...
for i in range(int(N/2)):
  geometry.append(mp.Cylinder(radius=r,center=mp.Vector3(0,i),height=mp.inf,material=mp.Medium(epsilon=1)))
for i in range(int(N/2)):
  geometry.append(mp.Cylinder(radius=r,center=mp.Vector3(0,-i),height=mp.inf,material=mp.Medium(epsilon=1)))
...
animate.to_gif(fps=10,filename='photonicwaveguide_split.gif')
